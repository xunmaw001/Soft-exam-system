<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="类型信息" prop="leixingxinxi">
          <el-input v-model="ruleForm.leixingxinxi" 
              placeholder="类型信息" clearable  :readonly="ro.leixingxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="类型信息" prop="leixingxinxi">
              <el-input v-model="ruleForm.leixingxinxi" 
                placeholder="类型信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='leixingxinxi'){
            this.ruleForm.leixingxinxi = obj[o];
	    this.ro.leixingxinxi = true;
            continue;
          }
        }
      }
